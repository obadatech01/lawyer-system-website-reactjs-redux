          ...
          <div className="row small-spacing">
            ...
            <div className="col-lg-3 col-md-6 col-xs-12">
              <Link to={"/cases"}>
                <div className="box-content bg-primary text-white">
                  <div className="statistics-box with-icon">
                    <i className="ico small fa fa-diamond"></i>
                    <p className="text text-white h3">{data.casesCompleted.name}</p>
            ...
            <div className="col-lg-3 col-md-6 col-xs-12">
              <Link to={"/sessions"}>
                <div className="box-content bg-danger text-white">
                  <div className="statistics-box with-icon">
                    <i className="ico small fa fa-diamond"></i>
                    <p className="text text-white h3">{data.casesNotCompleted.name}</p>
            ...
            <div className="col-lg-3 col-md-6 col-xs-12">
              <div className="box-content bg-violet text-white">
                <div className="statistics-box with-icon">
                  <i className="ico small fa fa-diamond"></i>
                  <p className="text text-white h3">{data.paymentsRemaining.name}</p>
            ...
            <div className="col-lg-3 col-md-6 col-xs-12">
              <div className="box-content bg-orange text-white">
                <div className="statistics-box with-icon">
                  <i className="ico small fa fa-diamond"></i>
                  <p className="text text-white h3">{data.expensesRemaining.name}</p>
